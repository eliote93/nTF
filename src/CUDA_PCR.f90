...
SUBROUTINE cuPrepareSPAI(M, SPAI)
USE PE_MOD,         ONLY : PE
IMPLICIT NONE
...
DO ic = 1, nc
  CALL cuPrepareSPAI_1Col(trM, trSPAI, ic, nc, tid)
END DO
!$OMP END DO
!$OMP END PARALLEL
...
SUBROUTINE cuPrepareSPAI_1Col(trM, trSPAI, i, nc, tid)
...
ierr = cusparseScsrmv(mySparseHandle, CUSPARSE_OPERATION_NON_TRANSPOSE, nr, nc, nnz, 1.0_4, SPAI%descr,             &
