...
USE SUBGRP_MOD,      ONLY : UpdtCoreIsoInfo, SubGrpFsp_CAT, SubGrpFsp_ISO, CalcDancoff, CalcEscXSCP
USE TH_Mod,          ONLY : Cal_RefFuelTemp
USE IOUTIL,          ONLY : terminate
USE SubGrpFspMLG_GM, ONLY : SubGrpFsp_MLG_GM
USE SubGrpFspMLG_NM, ONLY : SubGrpFSP_MLG_NM
