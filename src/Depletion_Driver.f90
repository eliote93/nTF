...
USE MKL_DEPL,      ONLY : Depletion_Driver_HP
#endif
#ifdef __PGI
USE CUDA_DEPL,      ONLY : Depletion_Driver_CUDA
#endif
...
Data lFirst /.TRUE./
#ifdef __PGI
IF (PE%lCUDADepl) THEN
  CALL Depletion_Driver_CUDA()
  RETURN
END IF
#endif
#ifdef __INTEL_MKL
IF (mklCntl%lDepl) THEN
  CALL Depletion_Driver_HP()
  RETURN
END IF
#endif
